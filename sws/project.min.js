...
$(document).ready(function() {
    ...
    if (undefined !== Cookies.get("locId")) {
        locId = Cookies.get("locId")
    } else {
    ...
    lang = $("#hiddenLang").val();
    date = $("#hiddenDate").val();
    startThisWeek = $("#startThisWeek").val();
    startNextWeek = $("#startNextWeek").val();
...
var aznEvent = function(a) {
    ...
    if (!a.next(".azn").hasClass("hidden")) {
        a.html("- ALLERGENE | ZUSATZSTOFFE | CO2 | NÃ„HRWERTE")
    } else {
        a.html("+ ALLERGENE | ZUSATZSTOFFE | CO2 | NÃ„HRWERTE")
    }
};
